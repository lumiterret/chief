    ...
    <div class="container">
        <div class="d-flex flex-wrap align-items-center justify-content-center justify-content-lg-start">
            ...
            <ul class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
                <li>
                    <a href="{{ route('recipes.index') }}" class="nav-link px-2 text-white"><i class="fa-solid fa-pizza-slice"></i>&nbsp; Рецепты</a>
                </li>
                <li>
                    <a href="{{ route('ingredients.index') }}" class="nav-link px-2 text-white"><i class="fa-solid fa-carrot"></i>&nbsp; Ингредиенты</a>
                </li>
            </ul>
